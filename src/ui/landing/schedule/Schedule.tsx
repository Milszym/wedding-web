...
export const Schedule = () => {
    ...
    const scheduleItems = [
        ...
        { time: "19:00", event: t('schedule.scheduleEvent4'), icon: <PhotoCamera />},
        { time: "20:00", event: t('schedule.scheduleEvent5'), icon: <Cake /> },
        { time: "20:15", event: t('schedule.scheduleEvent6'), icon: <MusicNote /> },
